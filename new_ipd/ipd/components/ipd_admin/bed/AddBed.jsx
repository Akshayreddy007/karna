            ...
            <Row className=" mt-5 mb-4">
              <Col md={6} className="pe-5 ps-md-4">
                <Form.Group className="mb-4 pb-4" controlId="formBasicEmail">
                  <Form.Label className="mb-0 f14">Bed Name</Form.Label>
                  <Form.Control
                    type="text"
              ...
              <Col md={6} className="pe-5 ps-md-4">
                <Form.Group className="mb-4 pb-4">
                  <Form.Label className="mb-0 f14">Bed Type</Form.Label>
              ...
              <Col md={6} className="pe-5 ps-md-4">
                <Form.Group className="mb-4 pb-4">
                  <Form.Label className="mb-0 f14">Department</Form.Label>
                  <Form.Select className={styles1.services_input}>
                    <option>select</option>
                    <option> Yes </option>
                  </Form.Select>
              ...
              <Col md={6} className="pe-5 ps-md-4">
                <Form.Group className="mb-4 pb-4">
                  <Form.Label className="mb-0 f14">Ward</Form.Label>
                  <Form.Select className={styles1.services_input}>
                    <option>select</option>
                    <option> Yes </option>
                  </Form.Select>
