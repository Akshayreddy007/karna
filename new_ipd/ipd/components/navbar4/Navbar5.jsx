...
import Sidenavbar_doctor from "../sidenavbar_ipd_doctor/SideNavbar";
const Navbar5 = () => {
  ...
  return (
    <React.Fragment>
      <div>
              ...
              <div className="dropdown1">
                <button className="dropbtn1">
                  <div className={`d-flex align-items-center ${styles.bdr}`}>
                    <Col className={` f12 text-center px-3 ${styles.texttr2}`} md={9}>Fttestdoctor2</Col>
                ...
                <div className={`bg-white ${styles.br32} `}>
                  <a href="#" className={`d-flex align-items-center ${styles.bdrbtm}`}>
                  <div><Image src={Logo3} className="" width="30" height="30" alt="logo" /></div>
                  <div className={`ps-2 theme14 f12 ${styles.lt14}`}>Sprint Fields Clinic <span className="theme12 f10">sfc@91care.com</span></div>
                   </a>
        ...
        <div className={`sidebar ${isOpen == true ? "active" : ""}`} id="sidebar">
          <Sidenavbar_doctor />
        </div>
        <div
